...
export default function DashboardPage() {
  ...
  const handleSaveImage = async () => {
    ...
    if (bgRemovedSegmentedImage) {
      ...
      setSaveWarnings("Please segment the image first.");
    }
        ...
        <div className="main-container z-[0] h-full pt-10 flex flex-col w-[80%] max-w-[1500px] mx-auto justify-around">
          <div className="flex justify-between gap-4 max-[800px]:flex-col max-[800px]:items-center">
            <div className="flex flex-col w-full gap-4 img-container max-[800px]:text-center max-[800px]:justify-center">
                  ...
                  >
                    ...
                    {showMarkers || bgRemovedSegmentedImage ? (
                      <div className="segmented-image-overlay z-[14] w-full h-full absolute top-0 left-0">
                        ...
                        {
                          !showMarkers && (
                            <Image id="bg-removed-image" src={bgRemovedImage} width={1000} height={1000} className="w-full h-full object-contain transition-all duration-500" alt="bg-removed-segmented-img" />
                          )
                        }
                      </div>
                    ) : (<></>)}
              ...
              {saveWarnings && (
                <div className="text-red-500 relative text-sm">{saveWarnings}</div>
              )}
                ...
                {selectedImage && (
                  <>
                    ...
                    <Button
                      ...
                      color="primary" variant="bordered" className="rounded-full w-fit text-primary"
                    >Save Image</Button>
                  </>
                )}
              </div>
